        ...
        <div class="row">
          <div class="col-md-3">
            ...
            <div class="card card-yellow">
              ...
              <!-- /.card-header -->
              <div class="card-body">
                <strong><i class="fas fa-book mr-1"></i> Inserção de Mão de Obra</strong>

                <p class="text-muted">
                  Cuidado para não inserir a mesma descrição de mão de obra várias vezes.
                </p>
          ...
          <div class="col-md-9">
            <div class="card">
              ...
              <div class="card-header">
                <h3 class="card-title">Editar Mão de Obra</h3>
              </div>
              <div class="card-body">
