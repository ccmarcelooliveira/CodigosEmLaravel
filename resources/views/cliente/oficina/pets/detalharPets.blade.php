            ...
            <div class="col-lg-12"> 
                ...
                <div class='col-lg-12'>
                    <p align='right'>
                        ...
                        @if($botaoEditar == "S")
                          <a href='{{ route('master::ediPets',[ 'id' => $idObjeto]) }}' class="btn btn-warning"> Editar</a>
                        @endif
                        @if($botaoExcluir == "S")
                          <a href='{{ route('master::excPets',[ 'id' => $idObjeto ]) }}' onclick="if(!confirm('Deseja deletar o Pet?')){return false;};" class="btn btn-warning"> Excluir</a>
                        @endif
