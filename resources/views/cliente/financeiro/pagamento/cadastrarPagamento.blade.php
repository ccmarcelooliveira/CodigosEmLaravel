            ...
            if(idVencto != "" && idConta != ""){
                ...
                $.ajax({
                    ...
                    success: function(result) {
                        //alert(result);
                        if(result == 'SPS'){ //SEM PREVISAO E UTILIZADO
                            disponibilizado = 0; 
                            utilizado = 0;
                        }
                        if(result == 'UTI100'){ // SEM PREVISAO E UTILIZADO 
                            disponibilizado = 0; 
                            utilizado = 100;
                        }
                        if(result > 0){
                        ...
                        //alert(disponibilizado + "-" + utilizado);               
...
//alert('teste' + disponivel + ' - ' + utilizado);
    ...
    function mascaraData(){
        ...
        if(data.length == 10){
            ...
            if(isValidDate(data) == true){
                document.getElementById("vencto").value = '';
            }     
        }
     }
</script>
        ...
        <div class='col-lg-12'>
                <div class='panel panel-primary'>
                    <div class='panel-heading'>
                        Cadastro de Nova Programação Financeira
                    </div>
