...
<div id="page-wrapper">
    ...
    <div class="col-xs-12">       
        ...
        <h1 class="page-header">
            Usuário(Funcionário) <small>Consultar</small>
        </h1>
        {!! $resp or '' !!}
                  ...
                  <div class="col-lg-12">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-heading">
                            <a href='{{ route('admin::cadastrarUsuarioFuncionario') }}'><img src='{{ asset('img/salvar.jpg') }}' width='20' title='Nova Turma' border=0></a> Novo Usuario (Funcionário)
                        </div>
