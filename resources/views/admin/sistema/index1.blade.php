...
<head>
    ...
    <title>Dagobá - Gestão Social Integrada e Inteligente</title>
...
<body>
    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">Dagoba - Gestão Social Integrada e Inteligente</a>
            </div>
            <!-- /.navbar-header -->
    ...
    <script src="{{ asset('bootstrapAdm/bower_components/raphael/raphael-min.js') }}"></script>
    <script src="{{ asset('bootstrapAdm/bower_components/morrisjs/morris.min.js') }}"></script>
    <script src="{{ asset('bootstrapAdm/js/morris-data.js') }}"></script>
