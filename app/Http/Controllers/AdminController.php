...
class AdminController extends Controller
{
    public function index(){
        ...
        return view('admin.sistema.dashboard', $data);
    }
    ...
    public function CadastrarSupNegocio(Request $request){ 
        $caminho = new \App\Models\CaminhoFisico();// ORIGEM DE TODOS OS CAMINHOS
        $controller = $caminho -> getCaminhoFisico("NEG");
        return $controller -> CadastrarInfNegocio($request);       
    }
    
    //CONSULTAR CONDOMINIO
    public function ConsultarSupNegocio(){
        $caminho = new \App\Models\CaminhoFisico();// ORIGEM DE TODOS OS CAMINHOS
        $controller = $caminho -> getCaminhoFisico("NEG");
        return $controller -> ConsultarInfNegocio();
        
    }
    
    //DETALHAR CONDOMINIO
    public function DetalharSupNegocio($id){
        $caminho = new \App\Models\CaminhoFisico();// ORIGEM DE TODOS OS CAMINHOS
        $controller = $caminho -> getCaminhoFisico("NEG");
        return $controller -> DetalharInfNegocio($id);
    }
